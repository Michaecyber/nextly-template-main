      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-orange-500 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
            Registration for our Mid-Year Intake, 2024 is now open!
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            Jiet College provides a wide range of educational options spanning various fields like engineering, management, media, and IT. With full-time, part-time, and online classes available, we cater to different schedules and learning styles, ensuring accessibility for all.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                href="https://jiet-edu.co.za/register/"
                target="_blank"
                rel="noopener"
                ...
                <span> Intake 2024 Now Open!</span>
              </a>
            </div>
          </div>
        </div>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-orange-600">150k+</span>{" "}
            students worldwide
          </div>
